...
- AlphaCut: int (SpriteBase3D.AlphaCutMode) = 0
...
**Methods:**
- GenerateTriangleMesh() -> TriangleMesh - Returns a TriangleMesh with the sprite's vertices following its current configuration (such as its `axis` and `pixel_size`).
- GetDrawFlag(int flag) -> bool - Returns the value of the specified flag.
- GetItemRect() -> Rect2 - Returns the rectangle representing this sprite.
