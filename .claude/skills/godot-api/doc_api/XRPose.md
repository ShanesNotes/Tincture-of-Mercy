...
- Name: StringName = &""
- TrackingConfidence: int (XRPose.TrackingConfidence) = 0
...
**Methods:**
- GetAdjustedTransform() -> Transform3D - Returns the `transform` with world scale and our reference frame applied. This is the transform used to position XRNode3D objects.
