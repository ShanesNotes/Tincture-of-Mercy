...
- MinSize: Vector2i = Vector2i(200, 70)
...
**Methods:**
- GetCancelButton() -> Button - Returns the cancel button. **Warning:** This is a required internal node, removing and freeing it may cause a crash. If you wish to hide it or any of its children, use their `CanvasItem.visible` property.
