...
- AutowrapTrimFlags: int (TextServer.LineBreakFlag) = 128
- ClipText: bool = false
- ExpandIcon: bool = false
- Flat: bool = false
- Icon: Texture2D
- IconAlignment: int (HorizontalAlignment) = 0
- Language: string = ""
- Text: string = ""
- TextDirection: int (Control.TextDirection) = 0
- TextOverrunBehavior: int (TextServer.OverrunBehavior) = 0
- VerticalIconAlignment: int (VerticalAlignment) = 1
