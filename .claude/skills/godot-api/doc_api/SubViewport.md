...
**Props:**
- RenderTargetClearMode: int (SubViewport.ClearMode) = 0
- RenderTargetUpdateMode: int (SubViewport.UpdateMode) = 2
- Size: Vector2i = Vector2i(512, 512)
- Size2dOverride: Vector2i = Vector2i(0, 0)
- Size2dOverrideStretch: bool = false
- ViewCount: int = 1
