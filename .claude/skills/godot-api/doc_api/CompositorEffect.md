...
**Props:**
- AccessResolvedColor: bool
- AccessResolvedDepth: bool
- EffectCallbackType: int (CompositorEffect.EffectCallbackType)
- Enabled: bool
- NeedsMotionVectors: bool
- NeedsNormalRoughness: bool
- NeedsSeparateSpecular: bool
