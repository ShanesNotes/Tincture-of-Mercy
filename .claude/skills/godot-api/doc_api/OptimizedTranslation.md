...
**Methods:**
- Generate(Translation from) - Generates and sets an optimized translation from the given Translation resource. **Note:** Messages in `from` should not use context or plural forms. **Note:** This method is intended to be used in the editor. It does nothing when called from an exported project.
