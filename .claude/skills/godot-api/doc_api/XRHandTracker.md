...
- HandTrackingSource: int (XRHandTracker.HandTrackingSource) = 0
- HasTrackingData: bool = false
...
**Methods:**
- GetHandJointAngularVelocity(int joint) -> Vector3 - Returns the angular velocity for the given hand joint.
- GetHandJointFlags(int joint) -> int - Returns flags about the validity of the tracking data for the given hand joint.
- GetHandJointLinearVelocity(int joint) -> Vector3 - Returns the linear velocity for the given hand joint.
- GetHandJointRadius(int joint) -> float - Returns the radius of the given hand joint.
- GetHandJointTransform(int joint) -> Transform3D - Returns the transform for the given hand joint.
- SetHandJointAngularVelocity(int joint, Vector3 angularVelocity) - Sets the angular velocity for the given hand joint.
- SetHandJointFlags(int joint, int flags) - Sets flags about the validity of the tracking data for the given hand joint.
- SetHandJointLinearVelocity(int joint, Vector3 linearVelocity) - Sets the linear velocity for the given hand joint.
- SetHandJointRadius(int joint, float radius) - Sets the radius of the given hand joint.
- SetHandJointTransform(int joint, Transform3D transform) - Sets the transform for the given hand joint.
