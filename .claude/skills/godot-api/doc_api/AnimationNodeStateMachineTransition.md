...
- AdvanceMode: int (AnimationNodeStateMachineTransition.AdvanceMode) = 1
- BreakLoopAtEnd: bool = false
- Priority: int = 1
- Reset: bool = true
- SwitchMode: int (AnimationNodeStateMachineTransition.SwitchMode) = 0
- XfadeCurve: Curve
- XfadeTime: float = 0.0
...
**Signals:**
- AdvanceConditionChanged - Emitted when `advance_condition` is changed.
