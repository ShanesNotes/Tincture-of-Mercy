...
**Props:**
- CubicInterp: bool = true
- HOffset: float = 0.0
- Loop: bool = true
- Progress: float = 0.0
- ProgressRatio: float = 0.0
- RotationMode: int (PathFollow3D.RotationMode) = 3
- TiltEnabled: bool = true
...
**Methods:**
- CorrectPosture(Transform3D transform, int rotationMode) -> Transform3D - Correct the `transform`. `rotation_mode` implicitly specifies how posture (forward, up and sideway direction) is calculated.
