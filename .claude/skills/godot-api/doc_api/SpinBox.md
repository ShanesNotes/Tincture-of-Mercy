...
- CustomArrowRound: bool = false
- CustomArrowStep: float = 0.0
- Editable: bool = true
- Prefix: string = ""
...
- Step: float = 1.0
- Suffix: string = ""
- UpdateOnTextChanged: bool = false
...
- GetLineEdit() -> LineEdit - Returns the LineEdit instance from this SpinBox. You can use it to access properties and methods of LineEdit. **Warning:** This is a required internal node, removing and freeing it may cause a crash. If you wish to hide it or any of its children, use their `CanvasItem.visible` property.
