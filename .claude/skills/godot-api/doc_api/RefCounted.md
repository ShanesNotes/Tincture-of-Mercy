...
**Methods:**
- GetReferenceCount() -> int - Returns the current reference count.
- InitRef() -> bool - Initializes the internal reference counter. Use this only if you really know what you are doing. Returns whether the initialization was successful.
