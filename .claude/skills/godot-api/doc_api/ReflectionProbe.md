...
**Props:**
- AmbientColor: Color = Color(0, 0, 0, 1)
- AmbientColorEnergy: float = 1.0
- AmbientMode: int (ReflectionProbe.AmbientMode) = 1
- BlendDistance: float = 1.0
- BoxProjection: bool = false
...
- ReflectionMask: int = 1048575
- Size: Vector3 = Vector3(20, 20, 20)
- UpdateMode: int (ReflectionProbe.UpdateMode) = 0
