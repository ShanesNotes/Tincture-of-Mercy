...
**Methods:**
- GetPlane() -> Plane - Returns a plane aligned with our anchor; handy for intersection testing.
- GetSize() -> Vector3 - Returns the estimated size of the plane that was detected. Say when the anchor relates to a table in the real world, this is the estimated size of the surface of that table.
