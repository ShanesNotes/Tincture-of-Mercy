...
**Props:**
- BlendMode: int (AnimationNodeBlendSpace1D.BlendMode) = 0
- CyclicLength: float = 0.0
- MaxSpace: float = 1.0
- MinSpace: float = -1.0
- Snap: float = 0.1
- Sync: bool
- SyncMode: int (AnimationNodeBlendSpace1D.SyncMode) = 0
...
- GetBlendPointCount() -> int - Returns the number of points on the blend axis.
- GetBlendPointName(int point) -> StringName - Returns the name of the blend point at index `point`.
- GetBlendPointNode(int point) -> AnimationRootNode - Returns the AnimationNode referenced by the point at index `point`.
- GetBlendPointPosition(int point) -> float - Returns the position of the point at index `point`.
- RemoveBlendPoint(int point) - Removes the point at index `point` from the blend axis.
...
- SetBlendPointPosition(int point, float pos) - Updates the position of the point at index `point` on the blend axis.
