...
**Props:**
- BlendShapes: float[] = PackedFloat32Array()
...
**Methods:**
- GetBlendShape(int blendShape) -> float - Returns the requested face blend shape weight.
- SetBlendShape(int blendShape, float weight) - Sets a face blend shape weight.
