...
**Methods:**
- Pack(Variant value) -> int - Packs the given container into a binary representation. The `value` must be either Array or Dictionary, any other type will result in invalid data error. **Note:** Subsequent calls to this method will overwrite the existing data.
