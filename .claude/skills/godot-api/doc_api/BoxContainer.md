...
**Methods:**
- AddSpacer(bool begin) -> Control - Adds a Control node to the box as a spacer. If `begin` is `true`, it will insert the Control node in front of all other children.
