...
- DrawOrder: int (CPUParticles2D.DrawOrder) = 0
- EmissionColors: Color[]
- EmissionNormals: Vector2[]
- EmissionPoints: Vector2[]
- EmissionRectExtents: Vector2
- EmissionRingInnerRadius: float
- EmissionRingRadius: float
- EmissionShape: int (CPUParticles2D.EmissionShape) = 0
...
**Methods:**
- ConvertFromParticles(Node particles) - Sets this node's properties to match a given GPUParticles2D node with an assigned ParticleProcessMaterial.
