...
- CommandOrControlAutoremap: bool = false
- CtrlPressed: bool = false
- Device: int = 16
- MetaPressed: bool = false
...
**Methods:**
- GetModifiersMask() -> int - Returns the keycode combination of modifier keys.
- IsCommandOrControlPressed() -> bool - On macOS, returns `true` if [kbd]Meta[/kbd] ([kbd]Cmd[/kbd]) is pressed. On other platforms, returns `true` if [kbd]Ctrl[/kbd] is pressed.
