...
**Props:**
- AutoExposureMaxExposureValue: float = 10.0
- AutoExposureMinExposureValue: float = -8.0
- ExposureAperture: float = 16.0
- ExposureShutterSpeed: float = 100.0
- FrustumFar: float = 4000.0
- FrustumFocalLength: float = 35.0
- FrustumFocusDistance: float = 10.0
- FrustumNear: float = 0.05
...
**Methods:**
- GetFov() -> float - Returns the vertical field of view that corresponds to the `frustum_focal_length`. This value is calculated internally whenever `frustum_focal_length` is changed.
