...
**Props:**
- AutoExposureMaxSensitivity: float = 800.0
- AutoExposureMinSensitivity: float = 0.0
- DofBlurAmount: float = 0.1
- DofBlurFarDistance: float = 10.0
- DofBlurFarEnabled: bool = false
- DofBlurFarTransition: float = 5.0
- DofBlurNearDistance: float = 2.0
- DofBlurNearEnabled: bool = false
- DofBlurNearTransition: float = 1.0
