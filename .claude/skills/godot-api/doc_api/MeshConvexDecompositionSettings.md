...
**Props:**
- ConvexHullApproximation: bool = true
- ConvexHullDownsampling: int = 4
- MaxConcavity: float = 1.0
- MaxConvexHulls: int = 1
- MaxNumVerticesPerConvexHull: int = 32
- MinVolumePerConvexHull: float = 0.0001
- Mode: int (MeshConvexDecompositionSettings.Mode) = 0
- NormalizeMesh: bool = false
- PlaneDownsampling: int = 4
- ProjectHullVertices: bool = true
- Resolution: int = 10000
- RevolutionAxesClippingBias: float = 0.05
- SymmetryPlanesClippingBias: float = 0.05
