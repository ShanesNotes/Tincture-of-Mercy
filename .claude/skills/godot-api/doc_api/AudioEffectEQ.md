...
**Methods:**
- GetBandCount() -> int - Returns the number of bands of the equalizer.
- GetBandGainDb(int bandIdx) -> float - Returns the band's gain at the specified index, in dB.
- SetBandGainDb(int bandIdx, float volumeDb) - Sets band's gain at the specified index, in dB.
