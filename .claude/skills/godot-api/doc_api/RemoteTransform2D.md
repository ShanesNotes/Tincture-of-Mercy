...
**Props:**
- RemotePath: NodePath = NodePath("")
- UpdatePosition: bool = true
- UpdateRotation: bool = true
- UpdateScale: bool = true
- UseGlobalCoordinates: bool = true
...
**Methods:**
- ForceUpdateCache() - RemoteTransform2D caches the remote node. It may not notice if the remote node disappears; `force_update_cache` forces it to update the cache again.
