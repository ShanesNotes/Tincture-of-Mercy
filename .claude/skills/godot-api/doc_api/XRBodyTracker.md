...
**Props:**
- BodyFlags: int (XRBodyTracker.BodyFlags) = 0
...
**Methods:**
- GetJointFlags(int joint) -> int - Returns flags about the validity of the tracking data for the given body joint.
- GetJointTransform(int joint) -> Transform3D - Returns the transform for the given body joint.
- SetJointFlags(int joint, int flags) - Sets flags about the validity of the tracking data for the given body joint.
- SetJointTransform(int joint, Transform3D transform) - Sets the transform for the given body joint.
