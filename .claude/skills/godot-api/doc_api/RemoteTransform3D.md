...
**Methods:**
- ForceUpdateCache() - RemoteTransform3D caches the remote node. It may not notice if the remote node disappears; `force_update_cache` forces it to update the cache again.
