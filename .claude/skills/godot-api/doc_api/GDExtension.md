...
**Methods:**
- GetMinimumLibraryInitializationLevel() -> int - Returns the lowest level required for this extension to be properly initialized (see the `InitializationLevel` enum).
- IsLibraryOpen() -> bool - Returns `true` if this extension's library has been opened.
