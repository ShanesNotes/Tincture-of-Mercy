...
**Props:**
- AlignmentHorizontal: int (AspectRatioContainer.AlignmentMode) = 1
- AlignmentVertical: int (AspectRatioContainer.AlignmentMode) = 1
- Ratio: float = 1.0
- StretchMode: int (AspectRatioContainer.StretchMode) = 2
