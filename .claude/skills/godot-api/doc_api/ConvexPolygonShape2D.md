...
**Methods:**
- SetPointCloud(Vector2[] pointCloud) - Based on the set of points provided, this assigns the `points` property using the convex hull algorithm, removing all unneeded points. See `Geometry2D.convex_hull` for details.
