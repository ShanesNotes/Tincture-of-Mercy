...
**Props:**
- Dry: float = 1.0
- FeedbackActive: bool = false
- FeedbackDelayMs: float = 340.0
- FeedbackLevelDb: float = -6.0
- FeedbackLowpass: float = 16000.0
- Tap1Active: bool = true
- Tap1DelayMs: float = 250.0
- Tap1LevelDb: float = -6.0
- Tap1Pan: float = 0.2
- Tap2Active: bool = true
- Tap2DelayMs: float = 500.0
- Tap2LevelDb: float = -12.0
- Tap2Pan: float = -0.4
