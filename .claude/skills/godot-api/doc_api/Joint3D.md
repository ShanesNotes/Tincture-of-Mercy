...
**Props:**
- ExcludeNodesFromCollision: bool = true
- NodeA: NodePath = NodePath("")
- NodeB: NodePath = NodePath("")
- SolverPriority: int = 1
...
**Methods:**
- GetRid() -> Rid - Returns the joint's internal RID from the PhysicsServer3D.
