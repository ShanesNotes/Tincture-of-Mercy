...
Tools live at `.codex/skills/godogen/tools/`. Run from the project root.
...
```bash
python3 .codex/skills/godogen/tools/asset_gen.py image \
...
Read `.codex/skills/godogen/rembg.md` for full guide: CLI, prompting strategy, troubleshooting, batch mode.
...
```bash
python3 .codex/skills/godogen/tools/asset_gen.py video \
...
```bash
python3 .codex/skills/godogen/tools/find_loop_frame.py assets/video/knight_walk_frames/
```
...
```bash
python3 .codex/skills/godogen/tools/rembg_matting.py \
...
```bash
python3 .codex/skills/godogen/tools/asset_gen.py glb \
...
```bash
python3 .codex/skills/godogen/tools/asset_gen.py rig \
...
```bash
python3 .codex/skills/godogen/tools/asset_gen.py retarget \
...
- Resume the stalled task with no extra cost:
  ```bash
  python3 .codex/skills/godogen/tools/asset_gen.py resume -o assets/glb/car.glb
  ```
...
```bash
python3 .codex/skills/godogen/tools/asset_gen.py set_budget 500
```
...
```bash
_log=$(mktemp)
result=$(python3 .codex/skills/godogen/tools/asset_gen.py image --prompt "..." -o path.png 2>"$_log") || tail -20 "$_log"
```
...
For any asset needing transparency, read `.codex/skills/godogen/rembg.md` first — covers BG color strategy, CLI, and troubleshooting.
...
```bash
python3 .codex/skills/godogen/tools/grid_slice.py path_grid.png \
