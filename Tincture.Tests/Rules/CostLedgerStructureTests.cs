...
public sealed class CostLedgerStructureTests
{
    private static string RepoRoot => Path.GetFullPath(Path.Combine(AppContext.BaseDirectory, "..", "..", "..", ".."));

    [Fact]
    public void CostLedgerStructure_OnlyCostLedgerEmitsResourceChangedEvents()
    {
        var sourceRoot = Path.Combine(RepoRoot, "Tincture.Substrate");
        var allowed = Path.Combine("Rules", "CostLedger.cs");
        var offenders = Directory
            ...
            .Where(file => file.text.Contains("EventType = \"resource_changed\"", StringComparison.Ordinal))
